...
export default function Signup() {
  ...
  return (
    <div className="pt-40 pb-20 container mx-auto px-4 max-w-md">
      ...
      >
        <h2 className="text-3xl font-serif font-bold italic mb-2 uppercase text-center">Join Us</h2>
        <p className="text-[10px] text-stone-400 font-bold uppercase tracking-widest text-center mb-8">Start your green journey today</p>
        ...
        <div className="mt-8 text-center pt-8 border-t border-stone-100">
          <p className="text-[10px] uppercase tracking-widest text-stone-400 font-bold mb-2">Already have an account?</p>
          <Link to="/login" className="text-[10px] font-black uppercase tracking-widest text-stone-900 hover:text-green-700 transition-colors">Sign in here</Link>
        </div>
      </motion.div>
    </div>
  );
