...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-stone-900 text-stone-400 h-screen sticky top-0 flex flex-col border-r border-stone-800 top-13">
      <div className="p-8">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 shrink-0">
            <img src="/logo.png" alt="A2B Farms" className="w-full h-full object-contain" referrerPolicy="no-referrer" />
          </div>
          <div>
